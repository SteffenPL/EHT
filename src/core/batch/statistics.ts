...
export const AVAILABLE_STATISTICS: StatisticDefinition[] = [
  // Cell counts
  {
    id: 'n_cells_total',
...
/** Get statistic by ID */
export function getStatistic(id: string): StatisticDefinition | undefined {
